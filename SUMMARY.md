...
- [Intrusion Detection (IDS)](features/ids.md)
- [Intrusion Prevention (IPS)](features/ips.md)
- [Data Loss Prevention (DLP)](features/dlp.md)
- [Rate Limiting](features/ratelimit.md)
- [DDoS Protection](features/ddos.md)
- [L4 Load Balancer](features/loadbalancer.md)
- [Threat Intelligence](features/threatintel.md)
- [L7 Firewall](features/l7-firewall.md)
- [DNS Intelligence](features/dns-intelligence.md)
...
- [VLAN / QinQ 802.1ad Support](features/vlan.md)
- [Connection Tracking](features/conntrack.md)
- [NAT](features/nat.md)
- [Policy Routing](features/routing.md)
- [Zone Segmentation](features/zones.md)
- [QoS / Traffic Shaping](features/qos.md)
- [Interface Groups](features/interface-groups.md)
...
- [Enterprise Features](features/enterprise/overview.md)
  ...
  - [Multi-Cluster](features/enterprise/multicluster.md)
  - [Multi-Tenancy](features/enterprise/multitenancy.md)
...
- [IDS](configuration/ids.md)
- [IPS](configuration/ips.md)
- [DLP](configuration/dlp.md)
- [L7 Firewall](configuration/l7.md)
- [Rate Limiting](configuration/ratelimit.md)
- [DDoS Protection](configuration/ddos.md)
- [L4 Load Balancer](configuration/loadbalancer.md)
- [Threat Intelligence](configuration/threatintel.md)
...
- [gRPC API](api-reference/grpc-api.md)
...
- [Hexagonal / DDD](architecture/hexagonal-ddd.md)
- [eBPF Programs](architecture/ebpf-programs.md)
...
- [Packet Pipeline](kernel/pipeline.md)
...
- [Adding a Domain](development/adding-a-domain.md)
- [eBPF Development](development/ebpf-development.md)
...
- [Web Application Protection](examples/scenarios/web-application.md)
- [Database Isolation](examples/scenarios/database-isolation.md)
- [PCI Compliance Scenario](examples/scenarios/pci-compliance.md)
- [Threat Hunting](examples/scenarios/threat-hunting.md)
