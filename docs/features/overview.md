...
|---------|------|----------|
| `xdp-firewall` | XDP | 4-phase pipeline, LPM trie, conntrack fast-path, TCP flags, ICMP, MAC, DSCP, aliases, connection limits, CPUMAP, FIB lookup for zone resolution, tail-call to rate limiter, interface groups |
